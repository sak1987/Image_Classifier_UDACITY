...
# To CHECK THE IMAGES IF IT CAN BE LOADED CORRECTLY , WE CREATE "GENERATOR & ITERATOR"
...
#WE CAN SAVE OUR TIME BY PRE-TRAINED MODEL & ADJUST THE CLASSIFIER INSTEAD OF BUILDING MODEL, BY IMPORTING vgg19
# Transfer learning with VGG19 'model' feature
...
#Replace the classifier with our new classifier
...
#
image_path = test_dir + '/34/image_06961.jpg'
...
#Check the image if its process correctly
...
#Assign models with labels to top_probs & top_labs
...
#witch the key and values of the index_to_class dictionary
idx_to_class = {}
...
#Show the names of the top label flowers
top_flowers2 = [cat_to_name[str(lab)] for lab in top_labels]
...
#TEST 
image_path = test_dir + '/45/image_07139.jpg'
